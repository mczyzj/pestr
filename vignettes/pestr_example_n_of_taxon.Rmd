...
abies_alba_pests$long_table %>%
   ...
   barplot(formula = n~labelclass, data = .,
           xlab = "Type of pest", ylab = "Number of species",
...
pests_taxonomy$compact_table %>%
  ...
  dplyr::group_by(taxonomy) %>% 
   dplyr::summarise(n = dplyr::n()) %>%
   barplot(formula = n~taxonomy, data = .,
           xlab = "Classification of pest", ylab = "Number of species",
           col = "#AF0011", ylim = c(0, 30))
```
